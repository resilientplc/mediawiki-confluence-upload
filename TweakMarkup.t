...
my $markup = <<'EOF';
  This is some markup with an [File__MyImage.png] embedded in it not once but [File__MyImage.png] twice.
  Here is another [File__OtherImage.png] image that's wrong. And a doc with an escaped name [File__T&amp;m-wo.doc].
